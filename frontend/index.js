...
$(document).ready(function() {
    ...
    $.get("api/faucet", (info) => {
        ...
        $("#ppc").html(info.payPerClick.toFixed(8) + " XPX");
        ...
        $("#submit").click(() => {
            ...
            {
                error.html("Please enter a valid Ripa address and solve the captcha");
            ...
            $.post("api/faucet", {"address": addr, "g-recaptcha-response": captchaResp}, (resp) => {
                ...
                success.html(`${info.payPerClick} XPX added to your account!`);
